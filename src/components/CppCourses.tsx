...
export const CppCourses: React.FC = () => {
  ...
  const courses = [
    {
      id: 'cpp-foundations',
      title: 'C++ Foundations',
      description: 'Understand C++ syntax, compilation, and core programming concepts',
      duration: '3 weeks',
      level: 'Beginner',
      students: 198,
      rating: 4.8,
      ...
      category: 'basics',
      to: '/courses/cpp',
      topics: ['Syntax', 'Variables', 'Control Flow', 'Functions', 'Arrays', 'Strings']
    },
    {
      id: 'cpp-beginners',
      title: 'C++ for Beginners',
      description: 'Build your first real C++ programs with memory and pointers basics',
      duration: '4 weeks',
      level: 'Beginner',
      students: 176,
      rating: 4.7,
      ...
      chapters: 8,
      category: 'beginner',
      to: '/courses/cpp-beginners',
      topics: ['Pointers', 'References', 'Dynamic Memory', 'File I/O', 'Structs', 'Enums']
    },
    {
      id: 'cpp-intermediate',
      title: 'C++ Intermediate',
      description: 'Master object-oriented programming and the Standard Template Library',
      duration: '6 weeks',
      level: 'Intermediate',
      students: 134,
      rating: 4.9,
      ...
      to: '/courses/cpp-intermediate',
      topics: ['Classes', 'Inheritance', 'Polymorphism', 'STL', 'Templates', 'Exception Handling']
    },
    {
      id: 'cpp-advanced',
      title: 'C++ Advanced',
      description: 'Dive into performance, concurrency, and modern C++ best practices',
      duration: '8 weeks',
      level: 'Advanced',
      students: 89,
      rating: 4.7,
      ...
      chapters: 16,
      category: 'advanced',
      to: '/courses/cpp-advanced',
      topics: ['Smart Pointers', 'Move Semantics', 'Multithreading', 'Networking', 'Design Patterns', 'C++20']
    }
  ];
  ...
  const groups = [
    {
      ...
      description: 'Get started with C++ syntax, compilation, and program structure'
    },
    {
      id: 'beginner',
      title: 'Beginners',
      description: 'Learn pointers, memory, and how to write useful C++ programs'
    },
    {
      id: 'intermediate',
      title: 'Intermediate',
      description: 'Build classes, use the STL, and leverage templates'
    },
    {
      id: 'advanced',
      title: 'Advanced',
      description: 'Master modern C++, concurrency, and high-performance patterns'
    }
  ];
        ...
        <div className="text-center mb-12">
          ...
          {sectionOpen && (
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Learn C++ from the basics through advanced systems and game development
            </p>
          )}
        </div>
