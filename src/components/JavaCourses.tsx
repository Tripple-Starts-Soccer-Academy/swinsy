...
export const JavaCourses: React.FC = () => {
  ...
  const courses = [
    {
      ...
      description: 'Learn Java syntax, the JVM, and object-oriented fundamentals',
      duration: '3 weeks',
      level: 'Beginner',
      students: 312,
      rating: 4.8,
      ...
      category: 'basics',
      to: '/courses/java',
      topics: ['Syntax', 'Variables', 'Control Flow', 'Methods', 'Classes', 'Packages']
    },
    {
      id: 'java-beginners',
      title: 'Java for Beginners',
      description: 'Write practical Java apps with collections, exceptions, and file I/O',
      duration: '4 weeks',
      level: 'Beginner',
      students: 267,
      rating: 4.7,
      ...
      chapters: 8,
      category: 'beginner',
      to: '/courses/java-beginners',
      topics: ['Collections', 'Exception Handling', 'File I/O', 'Generics', 'Lambdas', 'Streams']
    },
    {
      id: 'java-intermediate',
      title: 'Java Intermediate',
      description: 'Build robust applications with advanced OOP and concurrency',
      duration: '6 weeks',
      level: 'Intermediate',
      students: 189,
      rating: 4.9,
      ...
      to: '/courses/java-intermediate',
      topics: ['Inheritance', 'Polymorphism', 'Multithreading', 'JDBC', 'Networking', 'Testing']
    },
    {
      id: 'java-advanced',
      title: 'Java Advanced',
      description: 'Master enterprise patterns, Spring, and JVM performance tuning',
      duration: '8 weeks',
      level: 'Advanced',
      students: 121,
      rating: 4.7,
      ...
      chapters: 16,
      category: 'advanced',
      to: '/courses/java-advanced',
      topics: ['Spring Boot', 'Microservices', 'JVM Internals', 'Concurrency', 'Design Patterns', 'Security']
    }
  ];
  ...
  const groups = [
    {
      ...
      description: 'Start with Java syntax, the JVM, and object-oriented thinking'
    },
    {
      id: 'beginner',
      title: 'Beginners',
      description: 'Build practical Java programs using collections and exceptions'
    },
    {
      id: 'intermediate',
      title: 'Intermediate',
      description: 'Explore advanced OOP, concurrency, and application design'
    },
    {
      id: 'advanced',
      title: 'Advanced',
      description: 'Master enterprise Java, Spring, and JVM performance'
    }
  ];
  ...
  const CourseCard: React.FC<{ course: typeof courses[0] }> = ({ course }) => (
    <div className="p-4 bg-gradient-to-br from-sky-100 to-orange-100 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl hover:shadow-black transition-shadow">
      <div className="bg-gradient-to-r from-red-500 to-orange-600 p-6 text-white">
        ...
        <p className="text-red-100 mb-4">{course.description}</p>
        ...
        <div className="text-center mb-12">
          ...
          {sectionOpen && (
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Learn Java from the basics through enterprise application development
            </p>
          )}
        </div>
